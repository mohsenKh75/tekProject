                    ...
                    <Col lg={6} className="bg-white mx-auto vw-100">
                        <Row dir='ltr' className="d-flex justify-content-around max-vw-100" >
                            <Col className="p-3 d-flex justify-content-between">
                                <div className="mx-20">
                                    <Link url='/login'>
                                        <RegSvg style={{ backgroundColor: '#F1F9FD', height: "4vh", width: "3vw" }} className='py-1 rounded-circle' />
                                    </Link>
                                    <Link url='/register'>
                                        <small className="d-inline px-2 rounded-pill" style={{ color: 'black', fontSize: '1vw', backgroundColor: '#F1F9FD' }} >ثبت نام</small>
                                    </Link>
                                    <ShopSvg style={{ cursor: 'pointer', backgroundColor: '#F1F9FD', height: "4vh", width: "3vw" }} className='py-1 rounded-circle' />
                                </div>
                            </Col>
                            <Col className="p-2 d-flex justify-content-around">
                                <div className="flex-grow-2">
                                    <PlastAp style={{ height: "5vh", width: "4vw" }} className='rounded-circle' />
                        ...
                        <Row >
                            <div className="mobile-search-bar d-flex flex-column justify-content-center align-items-center w-100">
                                <div className="d-flex flex-column justify-content-center align-items-center">
                                    <input style={{ paddingLeft: '70vw' }} dir="rtl" className="mobile-search" type='text' />
                                </div>
                            </div>
                        </Row>
                        <Row dir='ltr' className="d-flex justify-content-center max-vw-100" >

                            <div style={{ paddingTop: '30%' }} className="background d-flex flex-row-reverse justify-content-center">
                                <div style={{ margin: '0.5rem' }} className="bg-light d-flex flex-row-reverse justify-content-between rounded-pill">
                                    <Dropdown style={{ width: 'auto' }} className="hidden bg-danger rounded-pill">
                                        <Dropdown.Toggle size='sm' style={{ margin: '0.5rem', boxShadow: 'none', borderBottom: 'none' }} className="no-border text-dark bg-danger rounded-pill" id="dropdown-basic">
                                            تهران
                                        </Dropdown.Toggle>
                                        <Dropdown.Menu>
                                ...
                                <div style={{ margin: '5px' }} className='hidden'>
                                    <Button style={{ width: '20vw' }} className="rounded-pill">ادامه</Button>
                                </div>
                            </div>
                                ...
                                <Col style={{ marginTop: '4vh' }} className="mobile-baners">
                                    <div className="intro-background d-flex flex-column justify-content-between">
                                        ...
                                        <div className="addInfo bg-primary">
                                            <small dir="rtl" className="text-main">فروش ویژه با ضمانت برگشت کالا تا هفت روز</small>
                                        </div>
                                    </div>
                            ...
                            <Row className="d-flex justify-content-center align-items-center my-4">
                                <h6 dir="rtl" className="text-center">پیشنهاد ویژه</h6>
                                <div style={{ width: '58vw' }} className="d-flex flex-row justify-content-center align-items-center bg-secondary">
                                    <PicsSpecial />
                                </div>
                            </Row>
                            <Row className="d-flex justify-content-center align-items-center my-4">
                                <div style={{ width: '58vw' }} className="d-flex flex-row justify-content-between align-items-center bg-primary above-footer">
                            ...
                            <div dir="ltr" className="my-5 d-flex flex-row justify-content-between">
                                ...
                                <div className="d-flex flex-wrap flex-row">
                                    <div className="conection-number py-7 d-flex flex-column justify-content-center align-items-center">
                                        ...
                                        <small className="text-primary mb-1" style={{ fontSize: '0.6rem' }}>پشتیبانی 24 ساعته</small>
                                    </div>
